...
from .natural_named_desktop_input_resident import NaturalNamedDesktopInputResidentRuntime
...
class ReportingMaintenanceResidentRuntime(NaturalNamedDesktopInputResidentRuntime):
