...
from .natural_file_desktop_submit_resident import NaturalFileDesktopSubmitResidentRuntime
...
class ReportingMaintenanceResidentRuntime(NaturalFileDesktopSubmitResidentRuntime):
