...
当前已核实的历史检查点（不是永久 HEAD）是：

```text
main: 4c6ea04aac001110e9315424d833d58d8e8df103
merge: rebase: E2E-08 onto Delegated Work readiness (#233)
post-merge ZN CI run: 34223104829
...
从当前 main 继续时，优先在 `docs/ZN-REAL-TASK-E2E-CATALOG.md` 和真实产品路径里选择仍然失败/覆盖不足的普通用户任务，尤其是：

- 真实 cross-surface task（Browser + Desktop + File/Terminal/Application）；
