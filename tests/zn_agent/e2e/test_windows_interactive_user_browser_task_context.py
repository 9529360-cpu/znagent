...
_DECOY_TITLE = "ZN Decoy Browser Page E2E"
    ...
    def _account_page(self, mode: str) -> bytes:
        if mode == "decoy":
            return super()._account_page(mode).replace(
                b"<title>ZN User Browser Bridge E2E</title>",
        ...
        body = """<!doctype html>
<html>
<head><meta charset="utf-8"><title>ZN User Browser Bridge E2E</title>
...
setInterval(async () => {
  ...
  changed = true;
  document.title = 'ZN Ambiguous Replacement E2E';
...
class WindowsInteractiveUserBrowserTaskContextE2ETests(
    ...
    def test_same_work_survives_foreground_decoy_and_semantic_drift_on_original_authorized_context(self) -> None:
        ...
        try:
            ...
            print(
                "ZN_USER_BROWSER_TASK_CONTEXT_E2E_EVIDENCE="
                + json.dumps(
                    {
