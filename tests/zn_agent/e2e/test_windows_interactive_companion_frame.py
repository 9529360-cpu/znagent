    ...
    def test_real_current_windows_context_has_stable_privacy_bounded_frame(self) -> None:
        ...
        with tempfile.TemporaryDirectory(ignore_cleanup_errors=True) as tmp:
            ...
            try:
                ...
                self.assertEqual(first.session_connection_state, "active")
                self.assertEqual(second.session_connection_state, "active")
                ...
                print(
                    ...
                    f"\"session_connection_state\":\"{first.session_connection_state}\","
