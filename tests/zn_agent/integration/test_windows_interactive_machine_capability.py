...
class WindowsInteractiveMachineCapabilityContractTests(unittest.TestCase):
    @staticmethod
    def _require_input_desktop() -> None:
        if os.name != "nt":
            raise unittest.SkipTest("Windows machine capability Contract runs only on Windows")
    ...
    def test_real_inventory_launch_verify_and_already_running_no_duplicate(self) -> None:
        ...
        with tempfile.TemporaryDirectory(ignore_cleanup_errors=True) as tmp:
            ...
            try:
                ...
                # outcome is valid here; the dedicated application-activation Contract
