...
from zn_agent.core.terminal import TerminalRequest, TerminalResult, ZNLocalTerminal
...
class NativeBodyInteractiveTerminalTests(unittest.TestCase):
    def test_body_exposes_terminal_input_and_resize_actions(self):
        ...
        body = NativeBody()
        with patch("zn_agent.core.body.get_zn_local_terminal", return_value=fake):
            written = body.act(
                "terminal_input",
                session_id="pty-1",
                data="yes\n",
