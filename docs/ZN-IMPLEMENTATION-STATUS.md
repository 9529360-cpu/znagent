...
| Safe modal recovery | CONNECTED + VERIFIED NARROW | exact same-process safe-modal recovery only; security/credential/business-decision dialogs remain fail-closed |
