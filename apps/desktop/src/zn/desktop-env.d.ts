...
type ZnDesktopResidentBridge = {
  ...
  recurringSchedule: (payload: ZnDesktopPayload) => Promise<unknown>
  recurringList: (payload?: ZnDesktopPayload) => Promise<unknown>
  recurringDisable: (payload: ZnDesktopPayload) => Promise<unknown>
